...
public class MainClass {
	public static void main(String[] args) {
		...
		// 하난 그리드 생성
		/*
		 * System.out.println("* HananGrid Info.."); System.out.println("  - Vertical: "
		 * + idp.getHanan_vertical()); System.out.println("  - Horizental: " +
		 * idp.getHanan_horizental());
		 * 
		...
		IGP = gl.getIGP();
		/*
		 * System.out.println("* Given Length is " + givenLength + ", this length is " +
		 * ConstOfGA.GIVENLENGTHVALUE + " * Total Length " + gl.getTotalLength());
		 * System.out.println("* IGP (SCALR OF IGP * (givenLength / totalLength)): " +
		 * IGP);
		 */
		...
		// 해 집단 확인
		/*
		 * System.out.println("\n* Before adjust Populations Info..."); for(int i = 0; i
		 * < ConstOfGA.SIZEOFPOPULATION; i++) { System.out.println(individuals[i]); }
		 */
		// 해 집단 조정연산
		Adjustment ad;
		CalLength cl;
		...
		/*
		 * System.out.println("\n* After adjust Populations Info..."); for(int i = 0; i
		 * < ConstOfGA.SIZEOFPOPULATION; i++) {
		...
		while (numOfGenerations <= ConstOfGA.NUMOFMAXIMUMGENERATIONS) {
			// GA1. Selection
			...
			/*
			 * System.out.println("\n* GA-1: Selection");
			 * System.out.println("  - Selected Index: " + selectionNum1 + ", " +
			 * selectionNum2);
			 ...
			 * System.out.println("  - ChildIndividualOne...");
			 * System.out.println(childIndividualArr[0]); System.out.print("    Fitness: " +
			 * childFitnessArr[0] + "\n");
			 * 
			 * System.out.println("  - ChildIndividualTwo...");
			 * System.out.println(childIndividualArr[1]); System.out.print("    Fitness: " +
			 * childFitnessArr[1] + "\n");
			 * 
			 * System.out.println("  - ChildIndividualThree...");
			 * System.out.println(childIndividualArr[2]); System.out.print("    Fitness: " +
			 * childFitnessArr[2] + "\n");
			 * 
			 * System.out.println("  - ChildIndividualFour...");
			 * System.out.println(childIndividualArr[3]); System.out.print("    Fitness: " +
			 * childFitnessArr[3] + "\n");
			 */
			...
			if (numOfGenerations % 10 == 0) {
				 Print printClass = new PrintPopulationSimpleInfo();
				 printClass.print(population);
			}
		...
		System.out.println("ControlGroupValue: " + controlGroupValue);
		Print printClass2 = new PrintPopulationInfo();
		printClass2.print(population);
	}
}
